...
class CLSTM_cell(nn.Module):
    ...
    def __init__(self, shape, input_chans, filter_size, num_features,cuda=False):
    ...
    def init_hidden(self, batch_size):
        h1,h2 = (Variable(torch.zeros(batch_size, self.num_features, self.shape[0], self.shape[1])),
...
class CLSTM(nn.Module):
    ...
    def __init__(self, shape, input_chans, filter_size, num_features, num_layers, cuda=False):
        ...
        if cuda:
            cell_list = [c.cuda() for c in cell_list]
